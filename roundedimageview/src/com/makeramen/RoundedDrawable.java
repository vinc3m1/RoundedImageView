...
public class RoundedDrawable extends Drawable {
	...
	public RoundedDrawable(Bitmap bitmap, boolean shouldScaleToSquare) {

		if (shouldScaleToSquare) {
			bitmap = scaleBitmapToSquare(bitmap);
		} else {
	...
	private Bitmap scaleBitmapToSquare(Bitmap bitmap) {
		...
		mShaderMatrix.preScale(scaleWidth, scaleHeight);
		mBitmapWidth = size;
		mBitmapHeight = size;
		return bitmap;
	}
